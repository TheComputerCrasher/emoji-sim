...
* Complete backwards compatibility with simulations made in the original!
...
* GET THE STUPID LOAD BUTTON WORKING
 ...
 * Try to optimize it by making the most common cell the default and only saving non-default cells
